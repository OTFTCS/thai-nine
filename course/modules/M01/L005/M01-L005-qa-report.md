...
- ✅ section-count: Lesson contains at least 4 teaching sections (Lesson contains 4 sections)
- ✅ section-depth: Each section includes at least 3 spoken narration lines (Each section has >=3 spoken narration lines)
- ✅ roleplay: Scenario roleplay included and substantial (Roleplay contains 10 lines)
...
- ✅ review-reuse: Lesson reuses at least 2 prior items when prior lesson context exists (Reused 4 prior vocabulary items in language focus)
- ✅ teaching-frame: Lesson includes a clear teaching frame with runtime and learner takeaway (Teaching frame targets 10-13 minutes)
...
- ✅ asset-research: Lesson provides at least one concrete image research query when visuals would help (Sections with concrete asset research queries: 2)
