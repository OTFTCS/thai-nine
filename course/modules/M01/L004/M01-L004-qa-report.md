...
- ✅ section-count: Lesson contains at least 4 teaching sections (Lesson contains 5 sections)
- ✅ section-depth: Each section includes at least 3 spoken narration lines (Each section has >=3 spoken narration lines)
- ✅ roleplay: Scenario roleplay included and substantial (Roleplay contains 7 lines)
...
- ✅ recap: Recap includes at least 3 review items (Recap contains 5 items)
- ✅ review-reuse: Lesson reuses at least 2 prior items when prior lesson context exists (Reused 2 prior vocabulary items in language focus)
- ✅ teaching-frame: Lesson includes a clear teaching frame with runtime and learner takeaway (Teaching frame targets 9-12 minutes)
- ✅ visual-plan: Each section includes a left-panel visual plan and explicit image decision (Every section includes visualPlan with usable teaching visuals and image rationale)
- ✅ asset-research: Lesson provides at least one concrete image research query when visuals would help (Sections with concrete asset research queries: 1)
